...
class JogaCarrocasPrimeiroTest {
	...
	@Test
	void testPassa() {
		JogaCarrocasPrimeiro estrategia = new JogaCarrocasPrimeiro();
	...
	@Test
	void testCarrocasPrimeiro() {
		JogaCarrocasPrimeiro estrategia = new JogaCarrocasPrimeiro();

		Jogada j1 = estrategia.decideJogada(mesa, List.of(new Peca(0, 2), new Peca(2, 6), new Peca(2, 2)));
	...
	@Test
	void testJogaPrimeiraCarrocaQueAchaNaMao() throws JogadaInvalidaException {
		mesa.jogaNaEsquerda(new Peca(3, 1));
		
		JogaCarrocasPrimeiro estrategia = new JogaCarrocasPrimeiro();

		Jogada j1 = estrategia.decideJogada(mesa, List.of(new Peca(0, 2), new Peca(2, 6), new Peca(3, 3), new Peca(3, 6), new Peca(2, 2)));
	...
	@Test
	void testJogaPrimeiraQueEncaixaSeNenhumaCarrocaEncaixar() {
		JogaCarrocasPrimeiro estrategia = new JogaCarrocasPrimeiro();
